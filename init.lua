if vim.g.vscode then
    ...
    vim.api.nvim_create_autocmd("FileType", {
        ...
        callback = function()
            ...
            if existing_lsp_id == nil then
                ...
                existing_lsp_id = #vim.lsp.get_clients() + 1 -- Client IDs start at 1
                vim.lsp.start({
                    name = "pyright-lsp",
    ...
    vim.keymap.set("n", '<leader>bd', ':<C-U>bprevious <bar> bdelete #<CR>', { noremap = true, silent = true, desc = "Close buffer (not window)" })
